...
public class CherryLeggings extends ArmorItem {
    public CherryLeggings() {
        super(ModArmorMaterials.CHERRY_ARMOR_MATERIAL, Type.LEGGINGS, new Properties()
                .durability(88).rarity(Rarity.COMMON));
    }
    @Override
