...
public class CherryChestplate extends ArmorItem {
    public CherryChestplate() {
        super(ModArmorMaterials.CHERRY_ARMOR_MATERIAL, Type.CHESTPLATE, new Properties()
                .durability(99).rarity(Rarity.COMMON));
    }
    @Override
