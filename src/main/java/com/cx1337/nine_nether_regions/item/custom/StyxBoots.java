...
public class StyxBoots extends ArmorItem {
    public StyxBoots() {
        super(ModArmorMaterials.STYX_ARMOR_MATERIAL, Type.BOOTS, new Properties()
                .rarity(Rarity.EPIC).durability(57775).fireResistant());
    }
    @Override
