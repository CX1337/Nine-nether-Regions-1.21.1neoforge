...
public class ModZhCnLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("tooltip.nine_nether_regions.styx_helmet_alt",
                "§6§o坚不可摧：§r§3§o正常情况下该装备耐久不会被消耗。如果通过某种手段使得该装备耐久受损，则装备耐久会极快速恢复（每4tick恢复42点）。\n§r§6§o全套效果——不动如山：§r§3§o当原始伤害≤3点或类型为§r§5§o魔法、§r§e§o爆炸、§r§3§o冰冻、§r§1§o监守者音波§r§3§o时，强制将伤害数值降低为0；持续提供§r§6§o抗性提升、伤害吸收§r§3§o效果（全效果3级）；每10tick强制恢复1.5点生命值并提供75%对于几乎所有伤害的减免。\n§r§6§o单件效果：§r§3§o持续提供§r§6§o夜视、水下呼吸、饱和§r§3§o效果（全效果2级），且免疫§7§o失明、黑暗、饥饿、血刃诅咒§r§3§o效果。");
        ...
        add("tooltip.nine_nether_regions.hellalloy_boots", "§3§o按下§r§6§oAlt§r§3§o以显示更多。");
