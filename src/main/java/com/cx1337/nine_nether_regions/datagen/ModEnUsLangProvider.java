...
public class ModEnUsLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("tooltip.nine_nether_regions.styx_boots_alt",
                "§6§oIndestructible:§r§3§oUnder normal circumstances, the durability of this equipment will not be depleted. If the durability of the equipment is damaged by some means, its durability will quickly recover (42 points restored every 4 ticks)\n§r§6§oFull Set Effect - Immovable as Mountains:§r§3§oWhen original damage ≤3 points or of type §r§5§oMagic, §r§e§oExplosion, §r§3§oFreeze, §r§1§oWarden's Sonic Boom§r§3§o, forcibly reduces damage to 0; continuously provides §r§6§oResistance Boost and Damage Absorption§r§3§o effects (all effects level 3); forcibly restores 1.5 health point every 10 ticks and provides 72% all damage reduction.\n §r§6§oSingle Piece Effect:§r§3§oContinuously provides §r§6§oSpeed§r§3§o effect (level 3), and grants immunity to §7§oSlowness, Levitation, Infested§r§3§o effects, while also providing 85% resistance to fall damage.");
